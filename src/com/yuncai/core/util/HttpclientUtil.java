...
public class HttpclientUtil {
    ...
    public static String sendGetRequest(String reqURL, String decodeCharset){  
        ...
        try{  
        	...
        	//httpGet.setHeader(HTTP.TARGET_HOST, "www.baidu.com");
        	//httpGet.setHeader(HTTP.USER_AGENT, "Mozilla/5.0+(compatible;+Baiduspider/2.0;++http://www.baidu.com/search/spider.html)");
    ...
    public static String sendPostRequest(String reqURL, String sendData, boolean isEncoder, String encodeCharset, String decodeCharset){  
        ...
        try{  
            ...
            log.error("与[" + reqURL + "]连接超时,自动返回空字符串");  
        } catch (SocketTimeoutException ste){  
            log.error("与[" + reqURL + "]读取超时,自动返回空字符串");  
        }catch(Exception e){  
    ...
    public static String sendPostSSLRequest(String reqURL, Map<String, String> params, String encodeCharset, String decodeCharset){  
        ...
        HttpClient httpClient = new DefaultHttpClient();  
        httpClient.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 10000); //连接超时,即URL连接的等待时间  
        httpClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, 10000);         //读取超时,即URL连接成功后,获取Response的等待时间  
...
//          br.close();  
    ...
    public static void main(String[] args) {
    	String content=sendGetRequest("http://apps.zs310.com/dz/spf/110520", "utf-8");
    	Map message=Jsons.toObject(content, Map.class);
	}
}
