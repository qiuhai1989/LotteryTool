...
public class LunarCalendar {
	...
	public String toString2() {
		...
		//lc.cyclical() 癸巳
		//
		//getChinaDayString( day)十二
		
		return "农历"+cyclical()+"年"+chineseNumber[month - 1] + "月" + getChinaDayString(day);
//		return year + "年" + (leap ? "闰" : "") + chineseNumber[month - 1] + "月" + getChinaDayString(day);
	}
	
	public static void main(String[] args) {
		  LunarCalendar lc = new LunarCalendar(Calendar.getInstance()) ;
		  System.out.println(lc.cyclical());
		  System.out.println(cyclicalm(12));
		  System.out.println(lc.toString());
		  System.out.println(lc.animalsYear());
		 System.out.println(getChinaDayString(12));
