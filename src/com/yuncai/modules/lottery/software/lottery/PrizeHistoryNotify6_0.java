...
public class PrizeHistoryNotify6_0 extends PrizeHistoryNotify{
	...
	public String execute(Element bodyEle, String agentId) {
		...
		try {
		    ...
		    //对list进行倒叙
//		    if(order==-1||order==0){
//		    	Collections.reverse(isusesList);
//		    }
		    //遍历结果集构造响应xml
		    ...
		    for(Isuses isuses :isusesList){
		    	...
		    	//一等奖^3^100000#二等奖^10^564655#未设置^0^0 胜负彩
		    		...
		    		List<PrizeLevelInfoBean> prizeLevelInfoBeans = new ArrayList<PrizeLevelInfoBean>();
