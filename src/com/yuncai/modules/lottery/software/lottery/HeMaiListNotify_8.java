...
public class HeMaiListNotify_8 extends HeMaiListNotify {
...
//					Isuses isuses = sqlIsusesService.findByLotteryTypeAndTerm(lotteryPlan.getLotteryType(), lotteryPlan.getTerm());
//					if(isuses!=null){
//						dealDateTime.setText(DateTools.DateToString_ddMMHHmm(isuses.getEndTime()));
//					}
//					LogUtil.out(lotteryPlan.getLotteryType().getName()+"---"+lotteryPlan.getLotteryType().getValue()+"----"+LotteryType.JCZQList.contains(lotteryPlan.getLotteryType()));
