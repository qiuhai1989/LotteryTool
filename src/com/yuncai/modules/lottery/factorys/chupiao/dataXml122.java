...
public class dataXml122  extends baseSplitXML 
{
	...
	private Logger log = Logger.getLogger(dataXml122.class); 
 
	public dataXml122(int dbType ,String transcode,String gameId,String issue,String ticketId) {
    ...
    {        
    	this.played=played;
		this.day=dayc;
		String fileType="gameResult";
		  if (!"".equals(issue)){
			  fileType="issueResult";
		  }			
        String strXML="<queryFile gameid='"+gameId+"' issue='"+issue+"' day='"+dayc+"' played='"+played+"' filetype='"+fileType+"' />";//122
	    doPost(url,strXML);
	    return statuscode;
    }
