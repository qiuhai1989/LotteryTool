...
public class dataXml112  extends baseSplitXML 
{
	...
	private Logger log = Logger.getLogger(dataXml112.class); 
 
	public dataXml112(int dbType ,String transcode,String gameId,String issue,String ticketId) {
    ...
    {
        String strXML="<queryprizenotice  gameid='"+gameId+"' issue='"+issue+"' province=''/>";//112
	    doPost(url,strXML);
	    return statuscode;
    }
