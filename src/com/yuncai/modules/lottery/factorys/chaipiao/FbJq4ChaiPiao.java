...
public class FbJq4ChaiPiao implements ChaiPiao {
	...
	public List chaiPiao(LotteryPlan lotteryPlan) throws Exception {
		...
		if (lotteryPlan.getSelectType().getValue() == 1) {
			try {
				...
				List list = Algorithm.checkOut(tempContent, Algorithm.FB_JQ_4);
	...
	public static void main(String[] args) {
		...
		bf.append("(310)0(31)03(31)01").append("\n").append("13003113");
		...
		FbJq4ChaiPiao dlt=new FbJq4ChaiPiao();
		try {
			dlt.chaiPiao(plan);
		} catch (Exception e) {
