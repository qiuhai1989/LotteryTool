...
public class FbBqcChaiPiao implements ChaiPiao{
	...
	public List chaiPiao(LotteryPlan lotteryPlan) throws Exception {
		...
		if (lotteryPlan.getSelectType().getValue() == 1) {
			try {
				tempContent = FileTools.getFileContentForUploadPlan(WebConstants.WEB_PATH + "/dsUpFile/130708/40St3qsC4XtsVdw.txt", " #");
	...
	public static void main(String[] args) {
		...
		bf.append("(31)33333333333").append("\n").append("110033010301");
		...
		FbBqcChaiPiao dlt=new FbBqcChaiPiao();
		try {
			dlt.chaiPiao(plan);
		} catch (Exception e) {
