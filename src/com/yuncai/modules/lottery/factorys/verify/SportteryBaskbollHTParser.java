...
import com.yuncai.modules.lottery.factorys.chaipiao.SportteryBasketHTChaiPiao;
...
public class SportteryBaskbollHTParser extends SportteryBaskParser<BasketBallBetContent, BasketBallMatchItem>{
	...
	public double getBetAmount(String comment, SelectType selectType, int multiple) throws Exception {
		...
		SportteryBasketHTChaiPiao chaiPiao = new SportteryBasketHTChaiPiao();
