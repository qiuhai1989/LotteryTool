...
public class PL5Parser implements ParserBuilder{
	...
	public static void main(String[] args) throws Exception {
		PL5Parser parser = new PL5Parser();
		StringBuffer sb = new StringBuffer();
		sb.append("2:(12)345(678)").append("\n").append("12345");
		sb.append("%1");
		ContentCheck check = parser.checkPlan(sb.toString(), 14);
