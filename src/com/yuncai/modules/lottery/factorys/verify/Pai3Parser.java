 ...
 * 
 */
public class Pai3Parser implements ParserBuilder{
	public static void main(String[] args) throws Exception {
		Pai3Parser parser = new Pai3Parser();
		StringBuffer sb = new StringBuffer();
		//sb.append("39:(12)34").append("\n").append("123"); //12,3,4
		//sb.append("29:01234");  //12
		//sb.append("30:1234"); //1234
		sb.append("32:1\r\n2\r\n4"); //两张票只支持单式投注7 | 8
		sb.append("\n").append("1\r\n2\r\n3");
		sb.append("%1");
		ContentCheck check = parser.checkPlan(sb.toString(), 14+10);
