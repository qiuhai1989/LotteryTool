 ...
 * 
 */
public class FbJq4Parser implements ParserBuilder{
	public static void main(String[] args) throws Exception {
		FbJq4Parser parser = new FbJq4Parser();
		StringBuffer sb = new StringBuffer();
		sb.append("2:(310)0(31)03(31)01").append("\n").append("13003113");
		sb.append("%1");

		ContentCheck check = parser.checkPlan(sb.toString(), 24+2);
