...
public abstract class SportteryBaskParser <T extends SportteryBetContentModelTurbid<X> ,X extends MatchItemTurbid> implements ParserBuilder{
	...
	public ContentCheck checkPlan(String content, double amount) throws Exception {
		...
		T betContent = CommonUtils.Object4JsonTurbid(content, getModelClass(), getMatchItemClass());
	...
	public abstract BkMatchService getSportteryService();
