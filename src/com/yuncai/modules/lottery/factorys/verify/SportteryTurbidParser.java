...
public abstract class SportteryTurbidParser <T extends SportteryBetContentModelTurbid<X> ,X extends MatchItemTurbid> implements ParserBuilder{
	...
	public ContentCheck checkPlan(String content, double amount) throws Exception {
		...
		T betContent = CommonUtils.Object4JsonTurbid(content, getModelClass(), getMatchItemClass());//(content, getModelClass(), getMatchItemClass());
