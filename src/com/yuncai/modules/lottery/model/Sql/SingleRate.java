...
/**
 * SingleRate entity. @author MyEclipse Persistence Tools
 */

public class SingleRate implements java.io.Serializable {
	...
	private Integer mainLoseball;
	private Date stopSellTime;
	private Integer matchId;
	private String europeSsp;
	private String europePsp;
	private String europeFsp;
	...
	private Double spfWin;
	private String spfWinDirection;
	private Double spfFlat;
	private String spfFlatDirection;
	private Double spfLose;
	 ...
	 * @param isHafu
	 */
	public SingleRate(String day, Date matchDate, String matchNumber,
			String game, String mainTeam, String guestTeam, Double win,
			Double flat, Double lose,Integer mainLoseball,Date stopSellTime,
			Integer matchId,String gameColor, Boolean isHhad,
			Boolean isCrs, Boolean isTtg, Boolean isHafu,Integer mid,Double spfWin, Double spfFlat, Double spfLose,Integer isSpf) {
		super();
		this.day = day;
	...
	public SingleRate(String day, Date matchDate, String matchNumber,
			String game, String mainTeam, String guestTeam, Double win,
			String winDirection, Double flat, String flatDirection,
			Double lose, String loseDirection, Double s10, String s10direction,
			Double s20, String s20direction, Double s21, String s21direction,
			Double s30, String s30direction, Double s31, String s31direction,
			Double s32, String s32direction, Double s40, String s40direction,
			Double s41, String s41direction, Double s42, String s42direction,
			Double s50, String s50direction, Double s51, String s51direction,
			Double s52, String s52direction, Double sother,
			String sotherDirection, Double p00, String p00direction,
			Double p11, String p11direction, Double p22, String p22direction,
			Double p33, String p33direction, Double pother,
			String potherDirection, Double f01, String f01direction,
			Double f02, String f02direction, Double f12, String f12direction,
			Double f03, String f03direction, Double f13, String f13direction,
			Double f23, String f23direction, Double f04, String f04direction,
			Double f14, String f14direction, Double f24, String f24direction,
			Double f05, String f05direction, Double f15, String f15direction,
			Double f25, String f25direction, Double fother,
			String fotherDirection, Double in0, String in0direction,
			Double in1, String in1direction, Double in2, String in2direction,
			Double in3, String in3direction, Double in4, String in4direction,
			Double in5, String in5direction, Double in6, String in6direction,
			Double in7, String in7direction, Double ss, String ssdirection,
			Double sp, String spdirection, Double sf, String sfdirection,
			Double ps, String psdirection, Double pp, String ppdirection,
			Double pf, String pfdirection, Double fs, String fsdirection,
			Double fp, String fpdirection, Double ff, String ffdirection,
			Integer mainLoseball, Date stopSellTime, Integer matchId,
